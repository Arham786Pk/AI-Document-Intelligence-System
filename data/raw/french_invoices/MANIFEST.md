...
**Source:** Real client samples provided by Muhammad Ahmed (2026-05-07)

> Real invoice files are **not committed** to the repository (see `.gitignore`).
> They live locally in `data/raw/french_invoices/` and are referenced by the ground-truth
> spreadsheet (`docs/ground_truth.csv`).
